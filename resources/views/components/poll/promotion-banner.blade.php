    ...
    <div class="flex justify-between items-center gap-5">
        <div>
            ...
            <p class="text-xs text-teal-800 mt-0.5">
                Gazi Social'da bulunan yüzlerce öğrenciye ulaşarak araştırmalarınızı daha geniş bir kitleye
                ulaştırabilirsiniz.
            </p>
            <x-link href="/learn-more" class="text-teal-900 text-xs flex items-center gap-0.5 mt-2 w-fit font-bold">
