<div x-data="{
    ...
    datePickerValue: $wire.entangle('{{ $attributes->get('wire:model') }}'),
    datePickerMonth: '',
    datePickerYear: '',
    datePickerDay: '',
    datePickerDaysInMonth: [],
    datePickerBlankDaysInMonth: [],
    datePickerMonthNames: ['Ocak', 'Şubat', 'Mart', 'Nisan', 'Mayıs', 'Haziran', 'Temmuz', 'Ağustos', 'Eylül', 'Ekim', 'Kasım', 'Aralık'],
    datePickerDays: ['Paz', 'Pzt', 'Sal', 'Çar', 'Per', 'Cum', 'Cmt'],
    ...
    <div class="w-full">
        <div class="relative">
            <input x-ref="datePickerInput" type="text" x-on:click="datePickerOpen=!datePickerOpen"
                ...
                placeholder="Tarih seçiniz" readonly>
            ...
            <div x-show="datePickerOpen" x-transition @click.outside="datePickerOpen = false"
                ...
                <div class="flex items-center justify-between mb-2">
                    <div x-data="{ showYearInput: false }">
                        ...
                        <span x-on:click="showYearInput = true" x-show="!showYearInput" x-text="datePickerYear"
