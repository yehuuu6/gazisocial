<footer class="py-12 px-[3%] md:px-[6%] lg:px-[12%] bg-blue-950 mt-7 md:mt-14">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div class="mb-4 md:mb-0">
            ...
            <p class="text-gray-100 text-base font-normal italic">
        ...
        <div class="flex gap-2 flex-col text-gray-200">
            ...
            <div class="flex flex-col gap-2">
                ...
                @endguest
                @auth
                    <x-link href="{{ route('users.edit', Auth::user()->username) }}" class="font-normal text-sm self-start">
                        Hesabım
                    </x-link>
                @endauth
            </div>
