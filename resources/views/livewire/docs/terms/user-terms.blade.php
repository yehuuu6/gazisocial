<div class="rounded-xl border border-gray-100 bg-white shadow-md p-8">
    <h1 class="text-3xl font-bold text-primary mb-6">Kullanım Koşulları (Terms of Use)</h1>
    ...
    <section class="mb-6">
        <h2 class="text-xl font-semibold text-gray-800 mb-2">3. Kullanıcı Sorumlulukları</h2>
        <p class="text-gray-700 mb-2">Kullanıcı olarak, aşağıdaki kurallara uymayı kabul edersiniz:</p>
        <ul class="list-disc list-inside text-gray-700">
            <li><strong>Saygılı Olun:</strong> Nefret söylemi, taciz veya saldırgan içerik paylaşmayın.</li>
            <li><strong>Orijinal İçerik Paylaşın:</strong> Başkalarına ait içerikleri izinsiz paylaşmayın veya
                kopyalamayın.</li>
    ...
    <section class="mb-6">
        <h2 class="text-xl font-semibold text-gray-800 mb-2">6. Yasaklı Davranışlar</h2>
        <p class="text-gray-700 mb-2">Kullanıcılar aşağıdaki faaliyetlerden kaçınmalıdır:</p>
        <ul class="list-disc list-inside text-gray-700">
            <li>Başkalarını taklit etmek veya yanlış bilgi vermek.</li>
            <li>Spam, kötü amaçlı yazılım veya dolandırıcılık içeren paylaşımlarda bulunmak.</li>
            <li>Açık veya yasa dışı içerik paylaşmak.</li>
        </ul>
    </section>

    <section class="mb-6">
        <h2 class="text-xl font-semibold text-gray-800 mb-2">7. Hesap Yönetimi</h2>
        <ul class="list-disc list-inside text-gray-700">
            <li>Hesabınızın güvenliğinden siz sorumlusunuz.</li>
            <li>Gazi Social, bu şartları ihlal eden hesapları askıya alma veya silme hakkını saklı tutar.</li>
        </ul>
    </section>
