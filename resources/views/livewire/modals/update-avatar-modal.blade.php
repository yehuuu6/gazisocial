        ...
        <form wire:submit.prevent="updateAvatar" lazy class="rounded-lg shadow-md" enctype="multipart/form-data">
            ...
            <div class="flex items-center justify-between">
                <h3 class="text-base md:text-xl py-3 px-5 md:py-4 md:px-6 text-gray-700 font-medium flex-grow">Profil
                    fotoğrafınızı
                    güncelleyin</h3>
                <button type="button" wire:click="removeAvatar" wire:loading.attr="disabled"
            ...
            <div class="px-6 py-4 flex flex-col items-center justify-center">
                <img id="imagePreview" class="mb-4 size-24 md:size-32 object-cover rounded-full"
                    src="{{ $url }}" alt="Image Preview">
                ...
                <input wire:model="avatar" type="file" hidden name="imageInput" id="imageInput" accept="image/*">
            ...
            <div class="bg-gray-50 p-4 sm:p-6 gap-2 flex items-center justify-end">
                <button type="button" @click="updateAvatarModal = false"
