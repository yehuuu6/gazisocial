<nav x-data="{ open: false }" id="navbar"
    ...
    <div class="relative mx-[3%] flex items-center justify-between md:mx-[6%] lg:mx-[12%]">
        ...
        <button @click="open = !open" class="flex text-primary items-center rounded-md p-1 hover:bg-gray-100 md:hidden"
            title="Menüyü Aç">
            <template x-if="open">
                ...
                <div x-data="{ open: false }">
                    ...
                    <div class="flex w-[225px] max-w-lg flex-col gap-1 rounded-md border border-gray-200 bg-white text-sm text-gray-800 shadow-lg"
                        ...
                        <form method="POST" action="{{ route('logout') }}" class="flex">
                            ...
                            @method('DELETE')
                            <button type="submit"
                                class="mx-1 flex-1 mb-1 flex items-center gap-3 rounded px-3 py-2 hover:bg-gray-100 hover:no-underline">
                                <x-icons.logout size="16" />
                                <span>Çıkış Yap</span>
                            </button>
                        </form>
