<nav x-data="{ navbarDropdown: false }" id="navbar"
    ...
    <div class="relative mx-[3%] flex items-center justify-between md:mx-[6%] lg:mx-[12%]">
        ...
        <button x-on:click="navbarDropdown = !navbarDropdown"
            class="flex text-primary items-center rounded-md p-1 hover:bg-gray-100 md:hidden" title="Menüyü Aç">
        ...
        <div x-cloak x-show='navbarDropdown' x-on:click.away="navbarDropdown = false" x-collapse
                ...
                <div class="flex items-center gap-3 p-2">
                    <div class="flex items-center gap-2 text-gray-600">
                        <button x-on:click="alert('Not implemented yet!');"
                            ...
                            <span
                                class="absolute size-2 top-2.5 right-2.5 animate-ping bg-blue-500 text-white rounded-full text-xs font-semibold">
                            </span>
                            <span
                                class="absolute size-2 top-2.5 right-2.5 bg-blue-500 text-white rounded-full text-xs font-semibold">
                            </span>
