                            ...
                            <label for="email" class="block font-medium text-gray-700">
                                ...
                                @if (Auth::user()->hasVerifiedEmail())
                                    @if (Auth::user()->isStudent())
                                        <span class="text-xs bg-green-500 ml-1 py-1 px-2 rounded-full text-white">Gazi
                                            Üniversitesine bağlılığınız onaylandı</span>
                                    @endif
                                @else
            ...
            <x-users.edit.container>
                ...
                <form wire:submit="deleteAccountPermanently" enctype="multipart/form-data">
                    <div class="flex flex-col gap-3 p-4">
                        ...
                        <button type="submit" wire:loading.attr="disabled" wire:target="deleteAccountPermanently"
                            wire:loading.class="animate-pulse"
