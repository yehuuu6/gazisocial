    ...
    <div class="bg-gray-50 border border-gray-200 px-8 pt-6 pb-8 mb-4 rounded-lg max-w-md w-full">
        <div class="flex flex-col gap-2 text-center">
            <div class="flex items-center justify-center relative">
                <span class="absolute top-[0.30rem] left-[12.75rem] w-4 h-4 bg-red-300 rounded-full"></span>
                <span
                    class="animate-ping absolute top-[0.30rem] left-[12.75rem] w-4 h-4 bg-red-300 rounded-full"></span>
                <svg class="size-14 text-blue-500" stroke="currentColor" fill="currentColor" stroke-width="0"
