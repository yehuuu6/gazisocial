<div wire:show="$parent.showLastWill" wire:transition.opacity x-cloak
    ...
    <div wire:show="$parent.showLastWill" wire:transition.scale
        ...
        <button x-on:click="$wire.$parent.showLastWill = false; $wire.call('saveLastWill')"
            class="flex items-center absolute top-2 right-2 justify-center p-2 bg-gray-100 hover:bg-gray-200 rounded-md text-gray-700">
        ...
        <textarea wire:model="lastWill" spellcheck="false" maxlength="1000"
            class="w-full min-h-[350px] bg-gray-50 text-gray-600 resize-none border border-gray-300 rounded-md p-2 outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent"
        ...
        <div class="flex items-center justify-between gap-2 mt-2">
            ...
            <x-ui.tooltip text="Sohbete Gönder" position="left">
                <button x-on:click="$wire.$parent.showLastWill = false; $wire.call('sendLastWillToChat')"
                    class="flex items-center justify-center p-2 bg-gray-100 hover:bg-gray-200 rounded-md text-gray-700">
